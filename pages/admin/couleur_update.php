    ...
    <div class="card-body">
        ...
        <form method="post">
            <div class="mb-3">
                ...
                <input name="nom" type="text" class="form-control <?= $nom_class_input ?? "" ?>" value="<?= $couleur_name ?>" id="nom" placeholder="Nike">
            ...
            <button type="submit" name="couleur_update" class="btn btn-success">Modifier</button>
        </form>
