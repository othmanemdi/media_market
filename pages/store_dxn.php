...
<nav aria-label="breadcrumb">
    <ul class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">منتجات dxn </li>
    </ul>
</nav>
                ...
                <div class="accordion-item mb-0 border-0 ronded mb-3">
                    <h2 class="accordion-header" id="headingOne">
                        <button class="accordion-button p-0 px-4 py-1 bg-transparent text-dark" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                            <div class="fw-bold h5 text-dark">التصنيفات</div>
                        </button>
                    </h2>
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne">
                        <div class="accordion-body">
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item text-uppercase"><a href="soins-personel"class="link-dark fw-bold my-3">fcb</a> </li>
                                <li class="list-group-item text-uppercase"><a href="soins-visage"class="link-dark fw-bold my-3">df</a> </li>
                                <li class="list-group-item text-uppercase"><a href="complement-alimentaire"class="link-dark fw-bold my-3">xcvbn</a></li>
                                <li class="list-group-item text-uppercase"><a href="beauty-gimbio"class="link-dark fw-bold my-3">fcb</a> </li>
                                <li class="list-group-item text-uppercase"><a href="beauty-kori"class="link-dark fw-bold my-3">fcb</a> </li>
                                <li class="list-group-item text-uppercase"><a href="jus-healthy"class="link-dark fw-bold my-3">fdvg</a> </li>
                                <li class="list-group-item text-uppercase"><a href="medicament-healthy"class="link-dark fw-bold my-3">fcb</a></li>
